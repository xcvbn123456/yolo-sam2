...
class YOLOv9ROSNode:
    def __init__(self):
        ...
        image_topic = rospy.get_param('~image_topic','/camera2/color/image_raw')
        image_result_topic = rospy.get_param('~image_result_topic','/yolov9/image_result2')
        bbox_topic = rospy.get_param('~bbox_topic','yolov9/bboxes2')
