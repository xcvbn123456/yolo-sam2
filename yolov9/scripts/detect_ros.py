...
class YOLOv9ROSNode:
    def __init__(self):
        ...
        image_topic = rospy.get_param('~image_topic','/camera1/color/image_raw')
        image_result_topic = rospy.get_param('~image_result_topic','/yolov9/image_result1')
        bbox_topic = rospy.get_param('~bbox_topic','yolov9/bboxes1')
        ...
        self.pub = rospy.Publisher(image_result_topic, Image, queue_size=1)
        self.bbox_pub = rospy.Publisher(bbox_topic,BoundingBoxes,queue_size=10)
